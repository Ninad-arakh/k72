...
const HomeTopText = () => {
  return (
    <div className="font-[font1] pt-2 text-center">
      ...
      <div className="text-[9.5vw] uppercase leading-[7vw] flex items-center justify-center">generates</div>
      <div className="text-[9.5vw] uppercase leading-[7vw] flex items-center justify-center">there</div>
      <div className="text-[9.5vw] uppercase leading-[7vw] flex items-center justify-center">creativity</div>
    </div>
  );
};
